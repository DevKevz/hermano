...
<div class="container">
    ...
    <div class="grid grid-cols-3 gap-6 mt-8">
        ...
        <div class="border p-4 text-center">
            <img src="{{ asset('assets/images/p1.png') }}" alt="Evergreen Tee" class="w-full">
        ...
        <!-- Product 2 -->
        <div class="border p-4 text-center">
            <img src="{{ asset('assets/images/p2.png') }}" alt="Slogan Tee" class="w-full">
        ...
        <!-- Product 3 -->
        <div class="border p-4 text-center">
            <img src="{{ asset('assets/images/p3.png') }}" alt="Staple Tee" class="w-full">

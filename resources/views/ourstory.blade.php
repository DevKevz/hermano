...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
        <img src="{{ asset('images/origin1.jpg') }}" alt="Origin Image 1" class="w-full rounded-lg shadow-md">
        <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
        ...
        <img src="{{ asset('images/mission.jpg') }}" alt="Mission Image" class="w-full rounded-lg shadow-md">
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
        <img src="{{ asset('images/vision.jpg') }}" alt="Vision Image" class="w-full rounded-lg shadow-md">
        <div>
